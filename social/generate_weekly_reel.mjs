...
function pageHtml(group, pageNum, totalPages, weekLabel, yearLabel, dateRangeTitle, getWeather) {
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .row { display:flex; align-items:center; gap:22px; border:2px solid #ff2d00; border-radius:6px; background: rgba(255,45,0,0.06); padding: 20px 42px 20px 26px; margin-bottom: 16px; }
